...
# 
# The availability of big data is transforming all professions, including Civil, Environmental, and Construction Engineering. Data-driven tools and
# algorithms have the promise to model nonlinear civil engineering phenomena and extract
# information that is not possible through traditional modeling methods. 
# 
# Machine learning is a fast growing field and its use in civil engineering will likely become routine in the next few years. The
# primary objective of this course is to provide a practical introduction and exposure to selected ML applications in Civil Engineering.
# 
# :::{note}
# The title of this JupyterBook is "Machine Learning by Example for Civil Engineers."  The intent is to indroduce various concepts, then show an example.  The two required textbooks are listed below; they go more into underlying theory of the various methods employed.
# :::
...
# |[Power Supply](https://www.amazon.com/CanaKit-Raspberry-Power-Supply-PiSwitch/dp/B07TSFYXBC/ref=pd_day0fbt_img_sccl_1/143-0240484-2623030?pd_rd_w=VvEoF&content-id=amzn1.sym.0a3d352f-2699-4ba2-810c-59dcb4abfa1b&pf_rd_p=0a3d352f-2699-4ba2-810c-59dcb4abfa1b&pf_rd_r=56GMWHGEPH151FJRAHWX&pd_rd_wg=FZHQw&pd_rd_r=30356ac1-7999-4e1e-a242-2a3b3f7f94ee&pd_rd_i=B07TSFYXBC&psc=1)|\$10.99|
# |[Micro SD Card Class 10 or faster](https://www.amazon.com/SanDisk-256GB-Extreme-microSD-Adapter/dp/B07FCR3316/ref=sr_1_2?crid=3KZ2LHC3OMR8U&keywords=micro+sd+card&nav_sdd=aps&qid=1659640639&refinements=p_n_feature_two_browse-bin%3A13203835011&rnid=6518301011&s=pc&sprefix=micro&sr=1-2)|\$34.99|
# |Total|\$230.97|
# 
...
# ## References
# 
# - [Burkov, A. (2019) The One Hundred Page Machine Learning Book](http://ema.cri-info.cm/wp-content/uploads/2019/07/2019BurkovTheHundred-pageMachineLearning.pdf) Required Textbook
# 
# - [Rashid, Tariq. (2016) Make Your Own Neural Network. Kindle Edition. ](https://www.goodreads.com/en/book/show/29746976-make-your-own-neural-network) Required Textbook
# 
